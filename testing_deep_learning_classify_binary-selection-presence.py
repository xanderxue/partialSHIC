...
'''usage eg:
python3 testing_deep_learning_classify_binary-selection-presence.py training.npy ./ 11 89 ./ accuracy roc_thresholds.txt confusion_matrix.pdf roc_curve.pdf
'''

if len(sys.argv)!=10:
  sys.exit("usage:\npython3 testing_deep_learning_classify_binary-selection-presence.py classifierPickleFileName fvecDir numSubWins numSumStatsPerSubWin resultsDir accuracyFilesPrefix thresholdsFileName confusionMatrixFigFileName rocCurveFigFileName\n")
else:
