...
'''usage eg:
python test_classifier.py AOM/training.npy FVs/AOM/ 11 92 AOM/ accuracy confusion_matrix.pdf
'''

if len(sys.argv)!=8:
  sys.exit("usage:\npython test_classifier.py classifierPickleFileName fvecDir numSubWins numSumStatsPerSubWin resultsDir accuracyFilesPrefix confusionMatrixFigFileName\n")
else:
